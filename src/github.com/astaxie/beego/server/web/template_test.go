...
func TestTemplate(t *testing.T) {
	...
	if err := beeTemplates["index.html"].ExecuteTemplate(os.Stdout, "index.html", nil); err != nil {
		t.Fatal(err)
	}
...
func TestFsBinData(t *testing.T) {
	...
	if err := beeTemplates["index.html"].ExecuteTemplate(os.Stdout, "index.html", map[string]string{"Title": "Hello", "SomeVar": "val"}); err != nil {
		t.Fatal(err)
	}
	out := bytes.NewBufferString("")
	if err := beeTemplates["index.html"].ExecuteTemplate(out, "index.html", map[string]string{"Title": "Hello", "SomeVar": "val"}); err != nil {
		t.Fatal(err)
	}
