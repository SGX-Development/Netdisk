...
func viewsIndexTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "views/index.html", size: 255, mode: os.FileMode(436), modTime: time.Unix(1541434906, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"views/index.html":        viewsIndexTpl,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"views": &bintree{nil, map[string]*bintree{
		...
		"index.html":  &bintree{viewsIndexTpl, map[string]*bintree{}},
	}},
}}
